...
const ServerName = "Minerva Servers";
const ServerSubName = "Half-Life 2 Roleplay";
const MiscMessages = [
	"Please keep in mind that we are in a heavy development phase!",
    "Minerva Servers is a gaming community hosting various Garry's Mod game servers.",
    "We focus on delivering enjoyable experiences for players of all types.",
    "The community encourages active participation and fosters a friendly atmosphere.",
];
